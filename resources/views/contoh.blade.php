            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="card shadow-sm h-100">
                        <img src="https://via.placeholder.com/600x400/0078D4/ffffff?text=Kegiatan+BEM" class="card-img-top" alt="Berita 1">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title fw-bold">BEM IT Del Sukses Gelar Webinar Nasional Technopreneurship</h5>
                            <p class="card-text text-muted small flex-grow-1">Acara ini menghadirkan pembicara ahli dari industri dan diikuti oleh ratusan mahasiswa dari seluruh Indonesia.</p>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="card shadow-sm h-100">
                        <img src="https://via.placeholder.com/600x400/0078D4/ffffff?text=Kegiatan+BEM" class="card-img-top" alt="Berita 2">
                        <div class="card-body d-flex flex-column">
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="card shadow-sm h-100">
                        <img src="https://via.placeholder.com/600x400/0078D4/ffffff?text=Kegiatan+BEM" class="card-img-top" alt="Berita 3">
                        <div class="card-body d-flex flex-column">
                ...
                <div class="col-lg-7" data-aos="fade-right">
                    ...
                    <div class="list-group">
                        ...
                        <a href="#" class="list-group-item list-group-item-action">
                            ...
                            <p class="mb-1 small text-muted">Pengambilan dapat dilakukan di Sekretariat BEM mulai tanggal 10-15 Agustus 2024.</p>
                        </a>
                        <a href="#" class="list-group-item list-group-item-action">
                            <div class="d-flex w-100 justify-content-between">
                            ...
                            <p class="mb-1 small text-muted">Bagi seluruh mahasiswa aktif angkatan 2023, segera daftarkan dirimu!</p>
                        </a>
                        <a href="#" class="list-group-item list-group-item-action">
                            <div class="d-flex w-100 justify-content-between">
                            ...
                            <p class="mb-1 small text-muted">Silakan unduh panduan dan persyaratan pada link yang tertera.</p>
                        </a>
                    </div>
                    <a href="/pengumuman" class="btn btn-outline-primary rounded-pill px-4 mt-4">Semua Pengumuman</a>
                </div>
                <!-- Kolom Kalender -->
                <div class="col-lg-5" data-aos="fade-left" x-data="calendar()">
