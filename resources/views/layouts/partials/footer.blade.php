    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-4 col-md-6">
                ...
                <p class="text-white-50 small">Badan Eksekutif Mahasiswa Institut Teknologi Del. Sinergi dalam Aksi,
                    Unggul dalam Karya.</p>
            </div>
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="#visi-misi" class="text-white-50 text-decoration-none">Visi & Misi</a>
                    </li>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled text-white-50 small">
                    <li class="d-flex mb-2"><i class="bi bi-geo-alt-fill me-2 mt-1"></i><span>Jl. Sisingamangaraja,
                            Sitoluama, Laguboti, Toba, Sumatera Utara</span></li>
