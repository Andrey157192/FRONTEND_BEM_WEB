    ...
    <div class="container">
        ...
        <div class="partner-marquee" data-aos="fade-up">
            <div class="partner-track">
                ...
                {{-- Set 1 --}}
                <img src="{{ asset('assets/logo.png') }}" class="partner-logo" alt="Logo Ormawa 1">
                <img src="{{ asset('assets/logo.png') }}" class="partner-logo" alt="Logo Ormawa 2">
                <img src="{{ asset('assets/logo.png') }}" class="partner-logo" alt="Logo Ormawa 3">
                <img src="{{ asset('assets/logo.png') }}" class="partner-logo" alt="Logo Ormawa 4">
                <img src="{{ asset('assets/logo.png') }}" class="partner-logo" alt="Logo Ormawa 5">
                <img src="{{ asset('assets/logo.png') }}" class="partner-logo" alt="Logo Ormawa 6">
                <img src="{{ asset('assets/logo.png') }}" class="partner-logo" alt="Logo Ormawa 7">
